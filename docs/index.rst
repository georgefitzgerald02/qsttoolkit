...
QSTToolkit is an open-source package for performing optical quantum state tomography (QST) research using both traditional (statistical) and novel deep learning-powered methods in Python. Key functionality includes:
   ...
   * Fast, compute-efficient and customisable generation of realistic synthetic data for a variety of optical quantum statesusing the `QuTiP <https://qutip.org/docs/4.0.2/index.html>`_ package.
...
Links
=====
- `QSTToolkit GitHub repository <https://github.com/georgefitzgerald02/qsttoolkit>`_
- `QSTToolkit PyPI page <https://pypi.org/project/qsttoolkit/>`_
